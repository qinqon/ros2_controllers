...
using swerve_drive_controller::STATE_STEER_LEFT_WHEEL;
using swerve_drive_controller::STATE_STEER_RIGHT_WHEEL;
using swerve_drive_controller::STATE_TRACTION_LEFT_WHEEL;
using swerve_drive_controller::STATE_TRACTION_RIGHT_WHEEL;

// name constants for command interfaces
using swerve_drive_controller::CMD_STEER_LEFT_WHEEL;
using swerve_drive_controller::CMD_STEER_RIGHT_WHEEL;
using swerve_drive_controller::CMD_TRACTION_LEFT_WHEEL;
using swerve_drive_controller::CMD_TRACTION_RIGHT_WHEEL;
