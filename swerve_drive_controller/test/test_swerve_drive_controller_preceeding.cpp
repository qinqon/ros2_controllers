...
TEST_F(SwerveDriveControllerTest, all_parameters_set_configure_success)
{
  ...
  ASSERT_EQ(controller_->swerve_params_.front_wheels_radius, front_wheels_radius_);
  ASSERT_EQ(controller_->swerve_params_.rear_wheels_radius, rear_wheels_radius_);
  ASSERT_EQ(controller_->swerve_params_.front_wheel_track, front_wheel_track_);
  ASSERT_EQ(controller_->swerve_params_.rear_wheel_track, rear_wheel_track_);
}
