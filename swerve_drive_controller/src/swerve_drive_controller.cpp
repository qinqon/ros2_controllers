...
controller_interface::CallbackReturn SwerveDriveController::configure_odometry()
{
  ...
  const double front_wheels_radius = swerve_params_.front_wheels_radius;
  const double rear_wheels_radius = swerve_params_.rear_wheels_radius;
  const double front_wheel_track = swerve_params_.front_wheel_track;
  const double rear_wheel_track = swerve_params_.rear_wheel_track;
